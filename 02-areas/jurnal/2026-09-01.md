...
## Fokus hari ini
- setup qadrlabs di rog

```
subl /home/linuxbrew/.linuxbrew/etc/php/8.5/php-fpm.d/www.conf
```

```
 brew services restart php@8.5
Stopping `php`... (might take a while)
==> Successfully stopped `php` (label: homebrew.php)
Created symlink '/home/gun-gun-priatna/.config/systemd/user/default.target.wants/homebrew.php.service' → '/home/gun-gun-priatna/.config/systemd/user/homebrew.php.service'.
...
```
$ ls -lah ~/php85-fpm.sock 
srw-rw---- 1 gun-gun-priatna www-data 0 Sep  1 11:39 /home/gun-gun-priatna/php85-fpm.sock
...
```
mkcert qadrlabs.test
```

output:
```
~/Projects/ssl/certs$ mkcert qadrlabs.test

Created a new certificate valid for the following names 📜
 - "qadrlabs.test"

The certificate is at "./qadrlabs.test.pem" and the key at "./qadrlabs.test-key.pem" ✅

It will expire on 1 December 2028 🗓

```

```
sudo subl /etc/nginx/sites-available/qadrlabs.test
```

```
server {
    listen 80;
    server_name qadrlabs.test;
...
server {
    ...
    root /home/gun-gun-priatna/Projects/qadrlabs/qadrlabs-frontend/public;
    index index.php index.html;

    ssl_certificate /home/gun-gun-priatna/Projects/ssl/certs/qadrlabs.test.pem;
    ssl_certificate_key /home/gun-gun-priatna/Projects/ssl/certs/qadrlabs.test-key.pem;
    ...
    location ~ \.php$ {
        ...
        fastcgi_pass unix:/home/gun-gun-priatna/php85-fpm.sock;
...
```
sudo ln -s /etc/nginx/sites-available/qadrlabs.test /etc/nginx/sites-enabled/
```
