...
eliverables
  ...
  3. Short description (149 chars): Spring Boot 4 authorization tutorial: give posts an owner and restrict edit and delete to the author or an admin using @PreAuthorize method security.
