...
tweet nuno maduro di x https://x.com/enunomaduro/status/2099559181384618475
```
you familiar with rust's cargo vet or go vet? we just did the same for php, introducing:

[@laravel](https://x.com/laravel)

vet see the code [composer update] is about to write into your vendor/ directory before it does ![🤌🏻](https://abs.twimg.com/emoji/v2/svg/1f90c-1f3fb.svg "Pinched fingers")


it's a dependency audit for php, so you actually know what's changing but we took it further: you can delegate the review to AI ![🤌🏻](https://abs.twimg.com/emoji/v2/svg/1f90c-1f3fb.svg "Pinched fingers") repository & documentation:
